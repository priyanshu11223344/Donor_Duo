      ...
      <div className="wrapper">
        <form onSubmit={handlesubmit}>
          ...
          <div className="input-box">
            <input type="text" placeholder="Username" id="email"  name="email" onChange={onChange} value={cred.email}/>
            <HiMail className='logos'/>
          </div>
          <div className="input-box">
            <input type="password" placeholder="Password" id="password" name="password" onChange={onChange} value={cred.password}/>
